...
# Add MIV_RV32_CFG3_C0_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {MIV_RV32_CFG3_C0} -instance_name {MIV_RV32_CFG3_C0_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {MIV_RV32_CFG3_C0_0:EXT_RESETN}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {MIV_RV32_CFG3_C0_0:TIME_COUNT_OUT}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {MIV_RV32_CFG3_C0_0:JTAG_TDO_DR}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:CLK" "CoreTimer_C0_0:PCLK" "CoreTimer_C1_0:PCLK" "MIV_ESS_C0_0:PCLK" "MIV_RV32_CFG3_C0_0:CLK" "PF_CCC_C0_0:OUT0_FABCLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:EXT_RST_N" "USER_RST" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:FABRIC_RESET_N" "CoreTimer_C0_0:PRESETn" "CoreTimer_C1_0:PRESETn" "MIV_ESS_C0_0:PRESETN" "MIV_RV32_CFG3_C0_0:RESETN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreJTAGDebug_TRSTN_C0_0:TGT_TCK_0" "MIV_RV32_CFG3_C0_0:JTAG_TCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreJTAGDebug_TRSTN_C0_0:TGT_TDI_0" "MIV_RV32_CFG3_C0_0:JTAG_TDI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreJTAGDebug_TRSTN_C0_0:TGT_TDO_0" "MIV_RV32_CFG3_C0_0:JTAG_TDO" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreJTAGDebug_TRSTN_C0_0:TGT_TMS_0" "MIV_RV32_CFG3_C0_0:JTAG_TMS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreJTAGDebug_TRSTN_C0_0:TGT_TRSTN_0" "MIV_RV32_CFG3_C0_0:JTAG_TRSTN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreTimer_C0_0:TIMINT" "MIV_RV32_CFG3_C0_0:MSYS_EI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreTimer_C1_0:TIMINT" "MIV_RV32_CFG3_C0_0:EXT_IRQ" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIV_ESS_C0_0:APB_0_mINITIATOR" "MIV_RV32_CFG3_C0_0:APB_INITIATOR" }
